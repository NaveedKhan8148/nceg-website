...
const SLIDES = [
  { tag: "Campus & Facilities",   title: ["National Centre of", "Excellence in Geology"], desc: "A premier institution advancing earth sciences research and education at the University of Peshawar, KPK, Pakistan.", caption: "University of Peshawar · KPK · Pakistan",      src: "/images/Sliders/slider0.jpg",   fallbackIcon: "🏔️" },
  { tag: "Laboratory Facilities", title: ["State-of-the-Art",  "Research Labs"],          desc: "14 cutting-edge laboratories equipped for frontier geoscience research and analysis.",                              caption: "14 World-Class Laboratories",                         src: "/images/Sliders/slider1.jpeg",  fallbackIcon: "🔬" },
  { tag: "Field Research",        title: ["Geological",        "Field Studies"],           desc: "Hands-on geological fieldwork across Pakistan's diverse and complex terrain.",                                     caption: "Field Studies · Pakistan",                            src: "/images/Sliders/slider2.jpeg",  fallbackIcon: "🌍" },
  { tag: "Academic Excellence",   title: ["Graduate",          "Programs"],                desc: "MS/M.Phil. and Ph.D. programs shaping the next generation of earth scientists.",                                   caption: "MS · M.Phil. · Ph.D. Programs",                       src: "/images/Sliders/slider3.jpeg",  fallbackIcon: "🎓" },
  { tag: "GIS & Remote Sensing",  title: ["G-SAG",             "Laboratory"],              desc: "GIS & Space Applications in Geosciences — HEC-funded, cutting-edge spatial research.",                            caption: "G-SAG Lab · HEC Funded",                              src: "/images/Sliders/slider4.jpeg",  fallbackIcon: "🛰️" },
  { tag: "Geological Samples",    title: ["Rock & Mineral",    "Collections"],             desc: "Extensive geological sample collections supporting teaching and research activities.",                              caption: "Geological Collections · NCEG",                       src: "/images/Sliders/slider5.jpeg",  fallbackIcon: "🪨" },
  { tag: "Research Instruments",  title: ["Advanced",          "Instrumentation"],         desc: "XRF, XRD, SEM and other advanced analytical instruments for precise geochemical analysis.",                       caption: "XRF · XRD · SEM Analysis",                            src: "/images/Sliders/slider6.jpeg",  fallbackIcon: "⚡" },
  { tag: "Seismology Lab",        title: ["Seismic",           "Research"],                desc: "Monitoring and studying seismic activity in the Pamir-Hindu Kush and surrounding regions.",                       caption: "Hydro-Geophysics & Seismology",                        src: "/images/Sliders/slider7.jpeg",  fallbackIcon: "📡" },
  { tag: "Gemology Lab",          title: ["Gemology",          "Laboratory"],              desc: "Pakistan hosts some of the world's finest gemstones. NCEG leads gemological research.",                           caption: "Gemology · Pakistan's Gem Heritage",                  src: "/images/Sliders/slider8.jpeg",  fallbackIcon: "💎" },
  { tag: "NCEG Building",         title: ["Historic",          "Institution"],             desc: "Established decades ago, NCEG remains Pakistan's foremost centre for geological sciences.",                        caption: "NCEG · Est. 1970s",                                   src: "/images/Sliders/slider9.jpeg",  fallbackIcon: "🏛️" },
  { tag: "Global Collaboration",  title: ["International",     "Partnerships"],            desc: "Active MoUs and research collaborations with leading universities and institutions worldwide.",                     caption: "Global Research Network · MoUs",                      src: "/images/Sliders/slider10.jpeg", fallbackIcon: "🌐" },
];
...
export default function Hero() {
  ...
  const goTo = useCallback((raw) => {
    ...
    setTimeout(() => {
      setCur(next);
      setVisible(true);
      // Scroll only the thumbnail strip — never hijack the page scroll
      if (thumbsRef.current) {
        const container = thumbsRef.current;
        const el = container.children[next];
        if (el) {
          const cLeft = container.scrollLeft;
          const cWidth = container.clientWidth;
          const eLeft = el.offsetLeft;
          const eWidth = el.clientWidth;
          if (eLeft < cLeft || eLeft + eWidth > cLeft + cWidth) {
            container.scrollTo({
              left: eLeft - cWidth / 2 + eWidth / 2,
              behavior: "smooth",
            });
          }
        }
  ...
  return (
    <section id="home" className="relative select-none">
      ...
      {/* ── MAIN SLIDE ─────────────────────────────────────────────── */}
      <div className="relative w-full overflow-hidden bg-[#0B1220]" style={{ height: "clamp(420px, 56vw, 620px)" }}>
